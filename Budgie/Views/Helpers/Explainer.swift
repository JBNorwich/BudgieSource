...
struct Explainer: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack {
                    Text("Budgie estimates your daily calorie burn from last week’s averages, subtracts your desired deficit, and calculates a **daily eating budget**. You can see this budget and how it's worked out for you on the Today screen.\n\nBudgie also works out a **target** for you, which is how much it thinks you should have eaten at a given point in the day.\n\nYour budget and target adjust throughout the day based on your activity; up if you exercise a lot, or down if you exercise less than usual.")
                        .padding()
